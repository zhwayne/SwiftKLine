...
final class PriceIndicatorRenderer: Renderer {
    ...
    init(configuration: Configuration) {
        ...
        highestTextLayer.font = configuration.font as CTFont
        highestTextLayer.fontSize = configuration.font.pointSize
        highestTextLayer.alignmentMode = .center
        highestTextLayer.contentsScale = UIScreen.main.scale
        
        lowestTextLayer.font = configuration.font as CTFont
        lowestTextLayer.fontSize = configuration.font.pointSize
    ...
    func draw(in layer: CALayer, context: Context) {
        ...
        priceLineLayer.strokeColor = configuration.textColor.cgColor
        highestTextLayer.foregroundColor = configuration.textColor.cgColor
        lowestTextLayer.foregroundColor = configuration.textColor.cgColor
